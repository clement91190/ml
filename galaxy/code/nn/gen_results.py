...
def get_results(method, learn_type, set):
...
def write(method, learn_type, set):
    ...
    with open(file, 'w') as fich:
        ...
        results, index = get_results(method, learn_type, set)
        print results[0]
...
def main():
    method = "method_gray"
    learn_type = "q1"
    write(method, learn_type, "test")
    write(method, learn_type, "train")
